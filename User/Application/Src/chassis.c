...
/* 按键宏定义 */
#define CHASSIS_AIMING_KEY   25  /*!< 底盘自瞄开启 */
...
pos_node_t pos_array[POS_NUM + EX_NODE_NUM] = {
    ...
    [1] = {5050.78f, 0.57f, -0.69f, POINT_TYPE_NUC_FLAT},
    [2] = {5055.11f, 6697.0f, -0.8f, POINT_TYPE_NUC_FLAT},
    [3] = {1623.0f, 5931.4f, 129.45f, POINT_TYPE_NUC_FLAT}, /*!< 点位信息，这个是投篮点位 */
    [4] = {118.0f, 6078.0f, 0.0f, POINT_TYPE_NUC_FLAT},
...
void chassis_auto_ctrl_task(void *pvParameters) {
    ...
    /* go_path中pid点位类型初始化 */
    pid_init(&nuc_flat_speed_pid, 3000, 1000, 5.0f, 50000.0f, POSITION_PID,
             3.0f, 0.0f, 2.0f);
    pid_init(&nuc_flat_angle_pid, 380, 8, 0.0f, 500.0f, POSITION_PID, 9.5 * 10.0f,  //修改
             0.0f, 2.0 * 10.0f);
